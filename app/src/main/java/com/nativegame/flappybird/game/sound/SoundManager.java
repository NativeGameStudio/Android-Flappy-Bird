package com.nativegame.flappybird.game.sound;
...
public class SoundManager {
    ...
    private void loadSounds() {
        ...
        loadEventSound(mContext, SoundEvent.PASS_PIPE, R.raw.sfx_score);
        loadEventSound(mContext, SoundEvent.HIT_PIPE, R.raw.sfx_hit);
        loadEventSound(mContext, SoundEvent.FLAPPING, R.raw.sfx_flap);
        loadEventSound(mContext, SoundEvent.START_GAME, R.raw.sfx_start);
        loadEventSound(mContext, SoundEvent.GAME_OVER, R.raw.sfx_die);
    }
